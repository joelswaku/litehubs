-- 011_remove_invitation_function_output_name_conflict.sql
-- Rename the function output fields so they cannot conflict with ordinary
-- organization_id columns inside INSERT ... ON CONFLICT statements.
