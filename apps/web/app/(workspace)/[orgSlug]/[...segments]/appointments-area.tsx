...
const checkInUrl = `${origin}/check-in/${orgSlug}/${item.site.code}?token=${item.checkinToken}`;
  const tvUrl = `/queue/${orgSlug}/${item.site.code}`;
