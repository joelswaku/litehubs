...
export function MembersArea({ orgSlug }: { orgSlug: string }) {
  ...
  return (
    <main className="mx-auto max-w-7xl space-y-6 p-4 sm:p-6 lg:p-8">
      <header className="relative overflow-hidden rounded-3xl border border-border-strong/80 bg-[radial-gradient(circle_at_91%_12%,rgba(37,99,235,.14),transparent_28%),radial-gradient(circle_at_8%_110%,rgba(45,212,191,.12),transparent_39%),linear-gradient(125deg,rgba(255,255,255,.98),rgba(241,245,249,.95)_52%,rgba(236,253,245,.90))] px-5 py-7 text-ink shadow-[0_28px_62px_-40px_rgba(15,23,42,.30)] dark:border-white/15 dark:bg-[radial-gradient(circle_at_92%_10%,rgba(57,135,229,.24),transparent_30%),radial-gradient(circle_at_7%_115%,rgba(13,148,136,.18),transparent_43%),linear-gradient(125deg,#1f252d,#15191f_58%,#14201d)] dark:shadow-[0_28px_62px_-40px_rgba(0,0,0,.9)] sm:px-7 sm:py-8">
